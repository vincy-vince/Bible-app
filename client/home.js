...
let updatedBook = document.getElementById("selectedBooks");
...
function updateBook(bookName) {
  ...
  console.log(meta[`${bookName}`].chapters);
  chaptersUpdate(meta[`${bookName}`].chapters);
}
